...
public enum DeviceType: String {
    ...
    var isPlusSize: Bool {
        return self == .iPhone6Plus || self == .iPhone6SPlus || self == .iPhone7Plus
    }
...
extension UIDevice {
    ...
    public var type: DeviceType {
        ...
        switch identifier {
        case "iPod5,1":                                 return DeviceType.iPodTouch5
        case "iPod7,1":                                 return DeviceType.iPodTouch6
        ...
        case "iPad6,3", "iPad6,4", "iPad6,7", "iPad6,8":return DeviceType.iPadPro
